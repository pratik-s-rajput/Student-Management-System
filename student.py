...
class Student:
    ...
    def __init__(self, root):
       ...
       # --------------manage frame------------------
       manage_frame = Frame(self.root, bd=3, relief=RIDGE, bg="lightblue")
       ...
       detail_frame.place(x=495, y=100, width=1000, height=600)
       ...
       table_frame.place(x=10, y=70, width=960, height=450)
